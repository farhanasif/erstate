...
@section('breadcrumb-title', 'Create Requisition confirmed Manage')
    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">Create Requisition confirmed Manage</h3>
        </div>
        @include('message')
        <!-- /.card-header -->
        <form action="{{ route('storeRQNConfirmed') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                  <div class="col-md-4">
              ...
              <div class="col-md-6">
                <div class="form-group">
                    <label>Is Confirmed ?</label><br>
                    <input type="radio" value="1" checked>&nbsp
                    <label for="yes">YES</label>&nbsp
                    <input type="radio" value="0">&nbsp
              ...
              <div class="card-footer">
                 ...
                 <a href="{{ route('allRQNConfirmed') }}" type="submit" class="btn btn-info">Back</a>
              </div>
        </form>
      </div>
      <!-- /.row -->
