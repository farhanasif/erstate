...
@section('dashboard-title', 'Edit Project Information')
    ...
    <div class="col-md-10">
        <div class="card card-success card-outline">
            ...
            <div class="card-body">
              <!-- /.card -->
                <!-- Horizontal Form -->
               <form class="form-horizontal form-label-left" action="{{route('updateProject',$project->id)}}" method="post">
                 @csrf
                      ...
                      <div class="col-md-10 offset-1">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-8 col-sm-8 ">
                            ...
                            <textarea name="description" class="form-control" placeholder="Description" id="" cols="30" rows="3"> {{$project->description}} </textarea>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Launching Date</label>
                              <div class="col-md-8 col-sm-8 ">
                                <input type="date" class="form-control" name="launching_date" id="launching_date" value="{{$project->launching_date}}">
                          ...
                          <div class="form-group row">
                            <label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Hand Over Date</label>
                              <div class="col-md-8 col-sm-8 ">
                                <input type="date" class="form-control" name="hand_over_date" id="hand_over_date" value="{{$project->hand_over_date}}">
