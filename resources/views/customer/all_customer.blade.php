              ...
              <tr>
                ...
                <td>
                  <div style="width: 150px; display: block;">
                    <a href="{{ route('editCustomer',$customer->id) }}" class="btn btn-warning" title="Edit"><i class="far fa-edit"></i></a>
                    <a href="{{ route('deleteCustomer',$customer->id) }}" class="btn btn-danger" title="Delete"><i class="far fa-trash-alt"></i></a>
                  </div>
                </td>
            </tr>
              @endforeach
