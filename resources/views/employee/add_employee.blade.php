...
@section('dashboard-title', 'Add Employee Information')
    ...
    <div class="col-md-10">
        <div class="card card-success card-outline">
            ...
            <div class="card-body">
              <!-- /.card -->
                <!-- Horizontal Form -->
               <form class="form-horizontal form-label-left" action="{{route('storeEmployee')}}" method="post" enctype="multipart/form-data">
                 @csrf
