...
@section('dashboard-title', ' All Sales Information')
@section('breadcrumb-title', 'All Sales Information')
...
<section class="content">
  ...
  <div class="card card-success card-outline">
    <div class="card-header">
        ...
        <a href="{{route('showAddSales')}}" class="btn btn-success float-sm-right"><i class="fas fa-plus"></i> Add Sales</a>
