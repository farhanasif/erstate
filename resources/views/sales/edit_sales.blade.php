    ...
    <div class="col-md-10">
        <div class="card card-success card-outline">
            ...
            <div class="card-body">
              <!-- /.card -->
                <!-- Horizontal Form -->
               <form class="form-horizontal form-label-left" action="{{route('updateSales',$sales->id)}}" method="post">
                 @csrf
                      ...
                      <div class="col-md-10 offset-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-3 ">
                              <input type="text" name="customer_name" class="form-control" placeholder="Customer Name" value="{{ $sales->customer_name }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-3 ">
                              ...
                              <textarea name="description" id="address" cols="3" rows="3" class="form-control" placeholder="Description">{{ $sales->amount }}</textarea>
